class AboutScope
  ...
  def test_dog_is_not_availavle_in_the_current_scope
  ...
  def test_you_can_reference_nested_classes_using_the_scope_operator
    ...
    assert_raise :joes_dog, rover.identify
  ...
  def test_bare_bones_class_name_assume_the_current_scope
    assert_equal true, AboutScope::String == String
  end

#It changes in v1.9 and it's now the same
