class AboutMessagePassing
  ...
  def test_send_with_undersocres_will_also_send_messages
    mc = MessageCatcher.new
...
#--------------------------
  ...
  def test_all_messages_are_caught
    ...
    assert_equal "foobar with <>", catcher.foobar
    assert_equal "foobaz with <1>",catcher.foobaz(1)
    assert_equal "sum with <1, 2, 3, 4, 5, 6>", catcher.sum(1,2,3,4,5,6)
  end
  ...
  def test_non_foo_message_are_treated_normally
    catcher = WellBehavedFooCatcher.new
