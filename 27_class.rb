class AboutClass
  ...
  def test_since_classes_are_objects_you_can_define_singleton_on_them
...
#----------------------
  LastExpressionInClassStatment = class Dog
                                    21
                                  end
  def test_class_statments_return_the_value_of_their_last_expression
    assert_equal 21, LastExpressionInClassStatment
  end

#------------------------------------
  SelfInsideOfClassStatments = class Dog
                                self
                               end
  def test_self_while_inside_class_is_class_object_not_instance
    assert_equal true, Dog == SelfInsideOfClassStatments
  end
#-------------------------------------
